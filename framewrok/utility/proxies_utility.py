...
class ProxyModel:
    ...
    def to_proxy_string(self) -> str:
        ...
        return f'{protocol}://{self.__ip}:{self.__port}'
...
class ProxiesUtility:
    ...
    @staticmethod
    def get_ssl_proxy_string() -> ProxyModel:
        ...
        for tr_tag in tr_tag_list:
            ...
            if proxy_model.get_anonymity() == 'elite proxy' or proxy_model.get_anonymity() == 'anonymous':
                proxies.append(proxy_model.to_proxy_string())

        return random.choice(proxies)


if __name__ == '__main__':
    ILog.debug(__file__, ProxiesUtility.get_ssl_proxy())
    ILog.debug(__file__, ProxiesUtility.get_ssl_proxy_string())
