...
class UrlLibUtility:
    ...
    @staticmethod
    def get(url: str, headers: dict = None, query_params: dict = None) -> ResponseObject:
        ...
        try:
            ...
            response_object = ResponseObject(data=content, code=code, process_time=process_time, url=url, message="",
                                             error="")
    ...
    @staticmethod
    def post(url: str, headers: dict = None, query_params: dict = None, form_data: dict = None) -> ResponseObject:
